...
static void _deinitPwr() {
	RCC->BDCR = 0x0000'0000UL;
	PWR->CR1  = 0x0000'0400UL;
}
...
static void _deinitClocks() {
	RCC->CR          = 0x0000'0063UL;
	RCC->CFGR        = 0x0000'0000UL;
	RCC->PLLCFGR     = 0x0000'1000UL;
	RCC->PLLSAI1CFGR = 0x0000'1000UL;
	RCC->PLLSAI2CFGR = 0x0000'1000UL;
	RCC->APB1ENR1    = 0x0000'0000UL;
}
...
static void _initFlash() {
	...
	FLASH->NSKEYR  = 0x4567'0123UL;
	FLASH->NSKEYR  = 0xCDEF'89ABUL;
	FLASH->OPTKEYR = 0x0819'2A3BUL;
	FLASH->OPTKEYR = 0x4C5D'6E7FUL;
